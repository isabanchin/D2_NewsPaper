...
SECRET_KEY = 'django-insecure-gcipc0qp3iu7qaf%2-gp4&n+y*3812$zex(-72wz95d%0+7^qw'
...
LOGGING = {
    ...
    "handlers": {
        ...
        "console_warn": {
            ...
            "filters": ['require_debug_true'],
            "class": "logging.StreamHandler",
            "formatter": "format_console_warn",
        },
        "console_err": {
            "level": "ERROR",
            "filters": ['require_debug_true'],
            "class": "logging.StreamHandler",
            "formatter": "format_console_err",
        },
        "file_general": {
            "level": "INFO",
    ...
    "loggers": {
        "django": {
            "handlers": ["file_general", "console", "console_warn", "console_err"],
            "level": "DEBUG",
            "propagate": True,
        },
        "django.request": {
